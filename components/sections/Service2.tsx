                  ...
                  <div className="row g-4">
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          Designing advanced chatbots using{" "}
                          <span className="text-secondary-2">OpenAI</span>,{" "}
                          <span className="text-secondary-2">Claude</span>, and{" "}
                          <span className="text-secondary-2">
                            real-time APIs
                          </span>
                          , to provide intelligent, personalized user
                          experiences and streamline customer support.
                        </p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          Creating voice and text-based AI agents tailored for
                          call center automation, outbound communications, and
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <h6 className="my-3 fw-medium">No-Code AI Builder</h6>
                        <p className="fs-7 text-300 fw-regular">
                          Enabling businesses to deploy AI chatbots and
                          automation workflows with no-code platforms, making AI
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          <span className="text-secondary-2">OpenAI</span>,{" "}
                          <span className="text-secondary-2">VAPI</span> and{" "}
                          <span className="text-secondary-2">Claude</span>, for
                          dynamic, real-time data processing and system
                          interoperability.
                        </p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          Optimizing AI-powered applications for speed and
                          accuracy, leveraging OpenAI and custom models to
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          Building intelligent e-commerce platforms that utilize
                          AI for personalized shopping experiences, predictive
                          analytics, and secure payment solutions.
                        </p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          Automating business workflows with AI technologies,
                          including OpenAI real-time APIs, custom-coded AI
                          solutions, and no-code platforms, to boost efficiency
                          and productivity.
                        </p>
                      </div>
                    </div>
