												...
												<div className="col-lg-8 col-md-7 col-10 mx-auto overflow-hidden">
													...
													<Marquee className="carouselTicker carouselTicker-left position-relative z-1">
														<ul className="carouselTicker__list m-0 ">
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/index-2/sql-logo.png" alt="brand" />
																</Link>
																<span className="tool-tip">MySQL</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/index-2/postgresql-logo.png" alt="brand" />
																</Link>
															...
															<li className="carouselTicker__item mt-6">
																...
																<span className="tool-tip">Pinecone</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/index-2/langchain-logo.jpg" alt="brand" />
																</Link>
																<span className="tool-tip">Langchain</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/index-2/chatgpt-logo.png" alt="brand" />
																</Link>
																<span className="tool-tip">Open AI</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
															...
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/index-2/azure.png" alt="brand" />
																</Link>
																<span className="tool-tip">Azure AI</span>
															</li>
														</ul>
													</Marquee>
												</div>
													...
													<Marquee className="carouselTicker carouselTicker-right position-relative z-1" direction="right">
														<ul className="carouselTicker__list m-0">
															<li className="carouselTicker__item mt-6">
																...
																<span className="tool-tip">TensorFlow</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/index-2/django-logo.png" alt="brand" />
																</Link>
																<span className="tool-tip">Django</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/index-2/docker.png" alt="brand" />
																</Link>
																<span className="tool-tip">Docker</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/index-2/aws.webp" alt="brand" />
																</Link>
																<span className="tool-tip">AWS</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/index-2/google-cloud.png" alt="brand" />
																</Link>
																<span className="tool-tip">Google Cloud</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/index-2/azure-logo.png" alt="brand" />
																</Link>
																<span className="tool-tip">Azure</span>
															</li>
															<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																	<img src="assets/imgs/index-2/heroku.png" alt="brand" />
																</Link>
																<span className="tool-tip">Heroku</span>
															</li>
														</ul>
													</Marquee>
												</div>
														...
														<ul className="ps-3 d-flex flex-column justify-content-between h-100 position-relative">
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	...
																	<span className="text-300">HTML, CSS, JavaScript, React, Angular, TailwindCSS</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">Back-End:</p>
																	<span className="text-300">Node.js, Express, Python, Django, FastAPI</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">Databases:</p>
																	<span className="text-300">MySQL, PostgreSQL, MongoDB, Pinecone (Vector DB)</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">AI &amp; Machine Learning:</p>
																	<span className="text-300">OpenAI, Azure AI, Claude AI, LangChain, Hugging Face, TensorFlow</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">Tools &amp; Platforms:</p>
																	<span className="text-300">Git, Docker, AWS, Google Cloud, Azure, Heroku</span>
																</div>
															</li>
															<li className="mb-3">
																<div className="d-flex flex-column flex-md-row gap-2">
																	<p className="text-dark text-nowrap mb-0">Others:</p>
																	<span className="text-300">RESTful APIs, GraphQL, Prompt Engineering, LLMOps, Agile Methodologies</span>
																</div>
															</li>
														</ul>
													</div>
