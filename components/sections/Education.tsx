                                            ...
                                            <li className="position-relative z-1 mb-3">
                                                <div className="d-flex gap-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-dark">
                                                            Agha Khan Board, Computer Science
                                                        </p>
                                    ...
                                    <ul className="ps-3">
                                        <li className="position-relative z-1 mb-3">
                                            <div className="d-flex gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-dark">
                                                        Certified in deploying AI models and
                                        ...
                                        <li className="position-relative z-1 mb-3">
                                            <div className="d-flex gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-dark">
                                                        Built AI-driven chatbots and automation
                                                        using GPT-based models.
                                                    </p>
                                                </div>
                                            </div>
                                        </li>
                                        <li className="position-relative z-1 mb-3">
                                            <div className="d-flex gap-2">
                                                ...
                                                <div>
                                                    <span className="gradient-heading">
                                                        Claude AI Innovation Award
                                                    </span>
                                                    <p className="text-dark">
                                                        Recognized for contributions in enhancing
                                        ...
                                        <li className="position-relative z-1 mb-3">
                                            <div className="d-flex gap-2">
                                                ...
                                                <div>
                                                    <span className="gradient-heading">
                                                        React.js Hackathon Winner
                                                    </span>
                                                    <p className="text-dark">
                                                        Developed React.js Saas based application
                                                    </p>
                                                </div>
                                            </div>
                                        </li>
                                        {/* <li className="position-relative z-1 mb-3">
                                            <div className="d-flex gap-2">
                                                ...
                                                <div>
                                                    <span className="gradient-heading">
                                                        {" "}
                                                        GenAI Enthusiast Award
                                                    </span>
                                                    <p className="text-dark">
                                                        Awarded for excellence in generative AI
